...
Project done during **Full Stack Software Engineering** at **ALX** to practice object oriented programming (OOP), Data Abstraction, Data Encapsulation, instances and classes attributes in **Python**.
